function [ ] = HCC_main(codeFolderName,imageFolderName,startingLowThreshold,startingHighThreshold,SpotSize,HoleSize,resolution,resultsFolderName, Min_Segment_Length, band_width)
%-------------------------------------------------------------------------%
%                                                                         %
...
% - band_width: is the width of the band used to derive HCC. The unit
% depends on the unit of the variable 'resolution'. d = 0.11 mm. Use Inf to use the entire image.
...
% Example for a call:
% HCC_main('HCC_MatLab_Code','HCC_Validation_Microstructures',100,255,60,10,0,'HCC_Validation_Results', 5, 100)
